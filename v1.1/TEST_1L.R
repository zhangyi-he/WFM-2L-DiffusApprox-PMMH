...
save(sel_cof, sel_cof, pop_siz, int_frq, int_gen, lst_gen, ptn_num, sim_num, sim_frq_WFM, sim_frq_WFD, 
     file = "./Output/Output v2.1/Test v1.1/TEST_1L_WFM_vs_WFD.rda")

load("./Output/Output v2.1/Test v1.1/TEST_1L_WFM_vs_WFD.rda")

pdf(file = "./Output/Output v2.1/Test v1.1/TEST_1L_WFM_vs_WFD.rda", width = 20, height = 10)
...
save(sel_cof, dom_par, pop_siz, smp_gen, smp_siz, smp_cnt, pop_frq, 
     file = "./Output/Output v2.1/Test v1.1/TEST_1L_SimData.rda")

load("./Output/Output v2.1/Test v1.1/TEST_1L_SimData.rda")

k <- min(smp_gen):max(smp_gen)
smp_frq <- smp_cnt %*% diag(1 / smp_siz)

pdf(file = "./Output/Output v2.1/Test v1.1/TEST_1L_SimData.pdf", width = 10, height = 10)
...
save(sel_cof, dom_par, pop_siz, smp_gen, smp_siz, smp_cnt, pop_frq, ptn_num, pcl_num, BPF, 
     file = "./Output/Output v2.1/Test v1.1/TEST_1L_BPF.rda")

load("./Output/Output v2.1/Test v1.1/TEST_1L_BPF.rda")
...
pdf(file = "./Output/Output v2.1/Test v1.1/TEST_1L_BPF_Likelihood.pdf", width = 20, height = 10)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
...
pdf(file = "./Output/Output v2.1/Test v1.1/TEST_1L_BPF_Particle.pdf", width = 20, height = 10)
...
save(sel_cof, dom_par, pop_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, gap_num, OptNum,
     file = "./Output/Output v2.1/Test v1.1/TEST_1L_OptNum.rda")

load("./Output/Output v2.1/Test v1.1/TEST_1L_OptNum.rda")

opt_pcl_num <- OptNum$opt_pcl_num
log_lik_sdv <- OptNum$log_lik_sdv

pdf(file = "./Output/Output v2.1/Test v1.1/TEST_1L_OptNum.pdf", width = 12, height = 9)
...
save(sel_cof, dom_par, pop_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, PMMH, 
     file = "./Output/Output v2.1/Test v1.1/TEST_1L_PMMH.rda")

load("./Output/Output v2.1/Test v1.1/TEST_1L_PMMH.rda")

load("./Output/Output v2.1/Test v1.1/TEST_1L_SimData.rda")

sel_cof_chn <- PMMH$sel_cof_chn
pdf(file = "./Output/Output v2.1/Test v1.1/TEST_1L_PMMH_Traceplot.pdf", width = 20, height = 5)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
...
pdf(file = "./Output/Output v2.1/Test v1.1/TEST_1L_PMMH_Posterior.pdf", width = 10, height = 10)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
...
save(sel_cof, dom_par, pop_siz, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, brn_num, thn_num, grd_num, BayesianProcedure, 
     file = "./Output/Output v2.1/Test v1.1/TEST_1L_BayesProc.rda")

load("./Output/Output v2.1/Test v1.1/TEST_1L_BayesProc.rda")
...
pdf(file = "./Output/Output v2.1/Test v1.1/TEST_1L_BayesProc_Posterior.pdf", width = 10, height = 10)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 2, cex.sub = 1.75, cex.axis = 1.75, cex.lab = 1.75)
hist(sel_cof_chn, breaks = seq(min(sel_cof_chn), max(sel_cof_chn), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient", 
     main = "Posterior for the selection coefficient")
